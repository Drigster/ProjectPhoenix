...
public partial class ChunkSystem : Node2D
{
	...
	private int _chunkCellSize = 16;
	private List<Vector2> _loadedChunks;
	...
	public override void _Ready()
	{
		...
		for (int x = -10; x < 10; x++)
		{
			for (int y = -10; y < 10; y++)
			{
				...
				_chunks.Add(new Vector2(x, y), newChunk);
	...
	public Chunk GetChunkAtWorldPosition(Vector2 worldPos, out int innerX, out int innerY)
	{
		...
		Chunk chunk = _chunks.GetValueOrDefault(new Vector2(x, y));
